                        ...
                        return (
                            <div>
                                <p><span> Tout a commencé en 1984 </span> avec la création du premier site de production Les Crudettes à
                                    Cavaillon. À partir de cette date on vous passe les détails, mais en gros ce fut une gentille et belle ascension, doucement mais sûrement, parce qu’une entreprise aussi ça se cultive et que ça a besoin de temps et d’investissement pour germer, pousser et puis s’élever.</p>
                                <p><span> Depuis 2013 </span>, nous avons rejoint le groupe LSDH, avec lequel nous partageons la vision : Passion, Ambition et Humanité. Un élan supplémentaire à notre développement.</p>
                                <p>Alors <span> 37 ans plus tard </span> nous voilà là. Un peu fiers mais pas trop, juste ce qu’il faut. Quand on se retourne, on est content du chemin parcouru et des terres labourées. Mais comme ce n’est pas dans cette direction-là qu’on va (en arrière), on continue de regarder devant, direction le plaisir lié aux innovations et à la création. Et c’est très excitant. Vraiment.</p>
                                ...
                                <p>D’abord, parce que Les Crudettes proposent des salades vertes et des salades composées fraîches et prêtes à manger, tous les jours de l’année, à tous les consommateurs en France (et aussi des crudités, des fruits, des herbes aromatiques, des jus de fruits, des soupes… toujours frais).</p>
                                ...
                                <p>Last but not least, nos déchets verts sont recyclés dans l’alimentation des animaux et dans le compostage. Nous recyclons également nos emballages.</p>
                                <p>(Vous aussi, pensez à trier vos emballages - nos emballages / produits peuvent faire l’objet d’une consigne de tri. Pour en savoir plus : www.consignesdetri.fr.)</p>
                                <p>Et (point important), nous apportons un soin particulier à l’eau que nous utilisons pour laver nos légumes en l’économisant et en la restituant au milieu naturel.</p>
